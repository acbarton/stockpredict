...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
    	<title>KJV Bible Verses</title>
        <link rel="shortcut icon" href="favicon.ico" type="image/x-icon" /> 
        <meta charset="UTF-8"/>
	<meta name="description" content="KJV Bible Verses"/>
	<meta name="keywords" content="KJV Bible Verses"/>
