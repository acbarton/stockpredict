...
class Network(object):
    ...
    def Test_Net_Predict(self, training_data, epochs, mini_batch_size, eta,
        ...
        fig=plt.gcf()
        fig.savefig(path+'CNN/display/aapl.png', bbox_inches='tight',dpi=None, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, pad_inches=0.1,
        frameon=None)
        #plt.show()    
        
        print '<h2>AAPL Daily Close: Past '+str(days)+' Days</h2>'
        print '<img src=\"scripts/python/AAPL/CNN/display/aapl.png\" onload=\"loadsim(\'AAPL\')\" >'
    ...
    def Test_Net_Simulate(self, training_data, epochs, mini_batch_size, eta,
        ...
        fig=plt.gcf()
        fig.savefig(path+'CNN/display/aapl_sim_'+str(days)+'.png', bbox_inches='tight',dpi=None, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, pad_inches=0.1,
        frameon=None)
        #plt.show()    
        ...
        print '<h2>AAPL Daily Close: Past '+str(days)+' Days</h2>'
        print '<img src=\"scripts/python/AAPL/CNN/display/aapl_sim_'+str(days)+'.png\" onload=\"hideyoyo()\" >'
