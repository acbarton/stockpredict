...
def main(invest,days):
    
    investment=[float(invest)]
    days = int(days)
    
    
    
    path ='/var/www/html/scripts/python/AAPL/CNN/'
    ...
    net.Test_Net_Simulate(training_data, epochs, mini_batch_size, 0.03, 
            validation_data, test_data, article_timestamps, closing_prices, closing_dates, investment, days, lmbda=0.1)
