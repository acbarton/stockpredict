...
def get_newPrices():
    ...
    url = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AAPL&apikey=XAPAO6Q6PIJ804G4&datatype=csv&outputsize=full'
    #response = requests.get(url)
    #jsonObject = response.json()
    #print jsonObject
    ...
    with requests.get(url, stream = True) as response:
        with open(path+'ParseArticles/daily_AAPL.csv','wb') as f:
