...
function booster_custom_header_setup() {
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'booster_custom_header_args', array(
...
add_action( 'after_setup_theme', 'booster_custom_header_setup' );

if ( ! function_exists( 'booster_header_style' ) ) :
/**
...
endif; // booster_admin_header_style

if ( ! function_exists( 'booster_admin_header_image' ) ) :
/**
